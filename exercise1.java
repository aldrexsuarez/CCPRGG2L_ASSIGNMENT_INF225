...
 
        // Provide regex pattern
        pattern = Pattern.compile("[0-2][0-3]|[0-5][0-9])[0-5][0-9]");
 
...
 
        // Provide regex pattern
        pattern = Pattern.compile("\\w+.(jpg|png|xlxs|txt");
...
        phonenumbers = phonenumbers.replaceAll("regex:\\b replacement:"+63");
 
...
[11:47 am] Romanillos, Shaira Twinkle
import java.util.regex.Matcher;
import java.util.regex.Pattern;
import java.util.Scanner;
 
